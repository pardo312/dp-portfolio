...
export default function Companies() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex w-full h-full items-center overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
